# Generated by Powerlevel10k configuration wizard on 2021-08-02 at 00:27 CEST.
...
#     ip                    # ip address and bandwidth usage for a specified network interface
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=244
  ...
  # Comentario para mostrar contexto
  ...
  # Borrada typeset -g POWERLEVEL9K_VPN_IP_CONTENT_EXPANSION=
  # Regular expression for the VPN network interface. Run `ifconfig` or `ip -4 a show` while on VPN
  # to see the name of the interface.
  # Original typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale)[0-9]*'
